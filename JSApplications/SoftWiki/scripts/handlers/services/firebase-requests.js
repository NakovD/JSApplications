...
export default {
    getRequest: async function (collectionName, ID, token) {
        let response;
        if (ID === '') {
    ...
    postRequest: async function (collectionName, ID, token, entityBody) {
        let requestBody = {
            method: 'POST',
    ...
    deleteRequest: async function (collectionName, ID, token) {
        let requestBody = {
            method: 'DELETE',
            headers: { "Content-Type": "application/json" }
        }
    ...
    putRequest: async function (collectionName, ID, token, entityBody) {
        let requestBody = {
            method: 'PUT',
    ...
    patchRequest: async function patchRequest(collectionName, ID, token, entityBody) {
        let requestBody = {
            method: 'PATCH',
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(entityBody)
