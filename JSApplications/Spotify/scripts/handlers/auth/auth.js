...
export async function registerHandler() {
    ...
    let userNameField = document.querySelector("#registerView > div > div > form > div:nth-child(1) > input");
    let passField = document.querySelector("#registerView > div > div > form > div:nth-child(2) > input");
    let regButton = document.querySelector("#registerView > div > div > form > button");
...
export async function logInHandler() {
    ...
    let logInButton = document.querySelector("#loginView > div > div > form > button");
